  ...
  return (
    <>
      <Section title="Preface & Disclaimers">
        <p>
          The analysis in this guide is provided in collaboration with Porom, Preheat, and the rest
          of the staff of the <a href="https://discord.gg/makGfZA">Altered Time</a> Mage Discord.
